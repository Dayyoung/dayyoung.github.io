...
<tr>
  <td colspan="2"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="243">
      <param name="movie" value="../img/sub_main_kr1.swf" />
      ...
      <!--[if !IE]>-->
      <object type="application/x-shockwave-flash" data="../img/sub_main_kr1.swf" width="920" height="243">
        <!--<![endif]-->
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="8.0.35.0" />
...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  <tr>
    ...
    <td id="title"><img src="../img/title_11_kr.jpg" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td id="leftmenu"><p><a href="Introduction.asp" target="_self">CEO 인사말</a></p>
      <p><a href="History.asp" target="_self">연혁</a></p>
      <p><a href="organization.asp" target="_self">조직도</a></p></td>
    <td><img src="../img/11_Introduction_kr.jpg" /></td>
  </tr>
  <tr>
