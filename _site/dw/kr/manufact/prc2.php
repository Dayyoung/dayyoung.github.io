    ...
    <td><table width="710" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="53" align="center"><table width="651" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><a href="prc.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','../img/33_prc_kr_01ov.jpg',1)"><img src="../img/33_prc_kr_01.jpg" border="0" id="Image6" /></a></td>
