...
imgSrcOv.push('../img/22_img00.jpg');
imgSrcOv.push('../img/22_img01.jpg');
imgSrcOv.push('../img/22_img02.jpg');


// 기본 탭 이미지
var imgSrcOt = new Array();
imgSrcOt.push('../img/22_img00.jpg');
imgSrcOt.push('../img/22_img01.jpg');
imgSrcOt.push('../img/22_img02.jpg');
...
<tr>
  <td colspan="2"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="243">
      <param name="movie" value="../img/sub_main_kr2.swf" />
      ...
      <!--[if !IE]>-->
      <object type="application/x-shockwave-flash" data="../img/sub_main_kr2.swf" width="920" height="243">
        <!--<![endif]-->
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="8.0.35.0" />
...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  <tr>
    ...
    <td id="title"><img src="../img/title_22_kr.jpg" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td id="leftmenu"><p class="br"><a href="pouch.php" target="_self">Pouch & Roll<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;제품</a></p>
      <p><a href="lldpe.php" target="_self">공압출필름</a></p></td>
    <td><table width="710" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><table width="640" border="0" cellspacing="0" cellpadding="0">
              <tr align="center">
                <td colspan="11" height="399"><img id='img0' src='../img/22_img00_on.jpg'><img id='img1' style='display:none' src='../img/22_img01_on.jpg'><img id='img2' style='display:none' src='../img/22_img02_on.jpg'></td>
              </tr>
              <tr>
                <td colspan="11" height="10"></td>
              </tr>
              <tr>
                <td width="100"><img id='menu0' name='menu0' src='../img/22_img00.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(0);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100"><img id='menu1' name='menu1' src='../img/22_img01.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(1);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100"><img id='menu2' name='menu2' src='../img/22_img02.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(2);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100">&nbsp;</td>
                <td width="8">&nbsp;</td>
                <td width="100">&nbsp;</td>
        ...
        <tr>
          <td><img src="../img/22_LLDPE-Film1.jpg" width="710" /></td>
        </tr>      
    </table></td>
  </tr>
  <tr>
