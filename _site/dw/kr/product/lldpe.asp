...
imgSrcOv.push('../img/22_img03.jpg');
...
imgSrcOt.push('../img/22_img03.jpg');
...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  ...
  <tr>
    <td id="leftmenu"><p class="br"><a href="pouch.asp" target="_self">Pouch & Roll<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;제품</a></p>
      <p><a href="lldpe.asp" target="_self">공압출필름</a></p></td>
    <td><table width="710" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><table width="640" border="0" cellspacing="0" cellpadding="0">
              <tr align="center">
                <td colspan="11" height="399"><img id='img0' src='../img/22_img01_on.jpg'><img id='img1' style='display:none' src='../img/22_img02_on.jpg'><img id='img2' style='display:none' src='../img/22_img03_on.jpg'></td>
              </tr>
              <tr>
                <td colspan="11" height="10"></td>
              </tr>
              <tr>
                <td width="100"><img id='menu0' name='menu0' src='../img/22_img01.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(0);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100"><img id='menu1' name='menu1' src='../img/22_img02.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(1);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100"><img id='menu2' name='menu2' src='../img/22_img03.jpg' style='cursor:hand;' onMouseOver='javascript_:fncClk(2);' width="100" height="72"></td>
                <td width="8">&nbsp;</td>
                <td width="100">&nbsp;</td>
                <td width="8">&nbsp;</td>
                <td width="100">&nbsp;</td>
