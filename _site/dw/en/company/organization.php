...
<tr>
  <td colspan="2"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="243">
      <param name="movie" value="../img/sub_main_en1.swf" />
      ...
      <!--[if !IE]>-->
      <object type="application/x-shockwave-flash" data="../img/sub_main_en1.swf" width="920" height="243">
        <!--<![endif]-->
        <param name="quality" value="high" />
        <param name="wmode" value="opaque" />
        <param name="swfversion" value="8.0.35.0" />
...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  <tr>
    <td id="leftmenu_img"><img src="../img/letf_11.jpg" /></td>
    <td id="title"><img src="../img/title_13_en.jpg" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td id="leftmenu"><p><a href="Introduction.php" target="_self">Introduction </a></p>
      <p><a href="History.php" target="_self">History</a></p>
      <p><a href="organization.php" target="_self">Organization</a></p></td>
    <td><img src="../img/13_Organization.jpg" /></td>
  </tr>
  <tr>
