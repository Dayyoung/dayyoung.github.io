...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  <tr>
    ...
    <td id="title"><img src="../img/title_22_en.jpg" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td id="leftmenu"><p class="br"><a href="pouch.php" target="_self">Pouch & Roll<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Products</a></p>
      <p><a href="lldpe.php" target="_self">Coextruded Films</a></p></td>
    <td><table width="710" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><img src="../img/22_LLDPE-Film.jpg" width="710"></td>
        </tr>
        <tr>
          <td height="3px;"><p>&nbsp;</p>
          <p>&nbsp;</p></td>
        ...
        <tr>
          <td><img src="../img/22_LLDPE-Film2.jpg" width="710" height="527"></td>
        </tr>        
      </table></td>
  </tr>
  <tr>
