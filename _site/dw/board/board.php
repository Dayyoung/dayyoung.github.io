...
<tr>
  <td colspan="2"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="920" height="243">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="../kr/img/sub_main_kr4.swf" width="920" height="243">
      <!--<![endif]-->
      <param name="quality" value="high" />
      <param name="wmode" value="opaque" />
      <param name="swfversion" value="8.0.35.0" />
...
<table width="920" border="0" cellspacing="0" cellpadding="0" id="con_bg">
  <tr>
    <td id="leftmenu_img"><img src="../kr/img/letf_55.jpg" /></td>
    <td id="title"><img src="../kr/img/title_51_kr.jpg" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td id="line"><img src="../kr/img/title_line.gif" /></td>
  </tr>
  <tr>
    <td id="leftmenu"><p><a href="board.php" target="_self">News/Notice</a></p></td>
    <td style="text-align:center"><iframe src="http://www.daewon-ind.co.kr/jboard/?code=TbBoard01" frameborder="0" width="710" height="500"></iframe></td>
  </tr>
  <tr>
