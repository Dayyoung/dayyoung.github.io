        ...
        <tr> 
          <td> 
            <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" height="140">
              ...
              <tr> 
                <td height="16" colspan="4" align="center">글을 삭제하려 합니다. 비밀번호를 입력하여 주십시오.</td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td height="14" width="63"> 
                  <div align="center"><input type="image" img src="img/i-pack/{ICON_PACK}/del.gif" border=0 value="삭제" onClick="chk_form();"></div>
                </td>
