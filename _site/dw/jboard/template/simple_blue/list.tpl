...
<!-- 여기부분을 추가 하였습니다. 게시판 제목을 출력해야 할거 같아서 -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="27" background="img/simple_blue/top-bg.gif">
          <tr> 
            ...
            <td width="18">
            <div align="center"><span id="all_select" style="cursor:hand" onClick="all_chk();" title="전체 선택"><img src="img/simple_blue/check.gif" width="12" height="13"></span></div>
            </td>
            <td width="35"> 
          ...
          <tr>
            <td height="85"> 
                ...
                <form method="get" action="./?p=detail&code={CODE}" name="mview_form">
                  ...
                  <tr> 
                    <td colspan=11 height=1>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="1" background="img/simple_blue/line.gif">
                        <tr>
                          <td height="1"></td>
                        </tr>
                      </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" background="img/simple_blue/down-bg.gif" height="43">
                <tr> 
                  <td width="10"><img src="img/simple_blue/down-left.gif" width="6" height="43"></td>
                  ...
                  <td width="10" height="43"> 
                    <div align="right"><img src="img/simple_blue/down-right.gif"></div>
                  </td>
                </tr>
              </table>
              </td>
