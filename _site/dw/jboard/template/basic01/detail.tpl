...
<table width="{B_WIDTH}" border="0" cellspacing="0" cellpadding="0">
  ...
  <!-- 다이나믹[multiview_link] :: 여러글 보기시의 페이지 링크 부분, 리스트, 새글이 링크가 출력됨 -->
        ...
        <tr>
          <td height="59">
            ...
            <table width="100%" border="0 cellspacing="1" cellpadding="0">
              ...
              <tr> 
                <td align=center width="100" bgcolor="#F2F2F2"><img src=img/basic01/name.gif></td>
                <td width="600">&nbsp;&nbsp;{NAME} {EMAIL}</td>
              </tr>
              <tr> 
                <td align=center width="100" bgcolor="#F2F2F2"><img src=img/basic01/sub.gif></td>
                <td width="600">&nbsp;&nbsp;<B>{SUBJECT}</B></td>
              </tr>
              <tr> 
                <td align=center width="100" bgcolor="#F2F2F2"><img src=img/basic01/homep.gif></td>
              ...
              <tr>
                <td colspan="2">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      <td width="15"></td>
                      <td colspan="2" align="right"><font color="#999999" style="font-size:8pt">{DATE}</font></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
<table border=0 width={B_WIDTH} cellspacing=0 cellpadding=0>
  <tr> 
    <td colspan=8 bgcolor=gray><img src=img/basic01/blank.gif height=2></td>
  </tr>
  <tr align=center height=22>
    <td width=50 height="15"><img src=img/basic01/prev.gif></td>
    <td align=left>
      <img src=img/basic01/blank.gif height=3>&nbsp; &nbsp;{PREV_ARTICLE}
    </td>
  </tr>
</table>
<table border=0 width={B_WIDTH} cellspacing=0 cellpadding=0>
  <tr>
    <td colspan=8 bgcolor=E8E8E8><img src=img/basic01/blank.gif height=1></td>
  </tr>
  <tr align=center height=22>
    <td width=50><img src=img/basic01/next.gif></td>
    <td align=left>
      <img src=img/basic01/blank.gif height=3>&nbsp; &nbsp;{NEXT_ARTICLE}
    </td>
  </tr>
</table>
<table border=0 cellpadding cellspacing=0 width={B_WIDTH}>
  <tr>
    <td colspan=10 bgcolor=silver><img src=img/basic01/blank.gif height=1></td>
  </tr>
</table>
<br>
