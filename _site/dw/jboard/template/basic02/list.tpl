...
<table width="{B_WIDTH}" border="0" cellspacing="0" cellpadding="0" height="88">
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="23" background="img/basic02/topbg.gif">
        <tr> 
          <td width="26"> 
            <div align="center"><span id="all_select" style="cursor:hand" onClick="all_chk();" title="전체 선택"><img src="img/basic02/check.gif"></span></div>
          </td>
          <td width="35"> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">번호</font></div>
          </td>
          <td> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">제목</font></div>
          </td>
          <td width="60"> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">이름</font></div>
          </td>
          <td width="36"> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">파일</font></div>
          </td>
          <td width="70"> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">날짜</font></div>
          </td>
          <td width="36"> 
            <div align="center"><img src="img/web/blank.gif" width="1" height="13"><font color="#FFFFFF">조회</font></div>
          </td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#EEECFF'"> 
          <td width="26" > 
            <div align="center"> 
	    ...
	    <tr><td colspan=10 height=1 bgcolor="#e1e1e1"><img src=img/basic02/blank.gif height=1></td></tr>
        <!-- END DYNAMIC BLOCK: contents -->
        </form>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="2" bgcolor="#336699">
        <tr> 
