...
<table width="{B_WIDTH}" border=0 cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td class=base>
      <table border=0 cellspacing=0 cellpadding=0 background='img/sgi_chocolate/title_read_bg.gif'>
        <tr valign=top>
          <td align=left><img src='img/sgi_chocolate/title_read_l.gif'></td>
          <td align=center><img src='img/sgi_chocolate/dummy.gif' width=1 height=12><br>
            <nobr>{SUBJECT}</nobr>
          </td>
          <td align=right><img src='img/sgi_chocolate/title_read_r.gif'></td>
        </tr>
      </table>
    </td>
