...
function scrTaker(opt){
	...
	for (i=1;i<=3;i++){
		...
		if (i==opt){
			...
			eval('document.scr_'+f).src = 'img/sgi_chocolate/scr_'+f+'_chk.gif';
		} else {
			eval('document.scr_'+f).src = 'img/sgi_chocolate/scr_'+f+'.gif';
		}
	}
}
-->
...
<table width="{B_WIDTH}" border=0 cellspacing=0 cellpadding=0>
  ...
  <tr>
    ...
    <td width='49' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_select.gif' usemap='#mView' border="0"></td>
    <td width='63' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_no.gif'></td>
    <td width='*' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_subject.gif'></td>
    <td width='72' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_name.gif'></td>
    <td width='63' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_file.gif'></td>
    <td width='65' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_date.gif'></td>
    <td width='63' background='img/sgi_chocolate/title_bg.gif' align=center><img src='img/sgi_chocolate/title_access.gif'></td>
  ...
  <tr>
    ...
    <td align=left colspan=7 background='img/sgi_chocolate/line_bg.gif'><img src='img/sgi_chocolate/line_bg.gif'></td>
      ...
      <table border=0 cellpadding=0 cellspacing=0>
        ...
        <tr>
          <td align=center>
            ...
            <input type=image value='submit' src='img/sgi_chocolate/scr_lupe.gif' align=absmiddle style="border:0">
          </td>
        </tr>
        <tr>
          <td align=center>
            <img src='img/sgi_chocolate/scr_name.gif' name='scr_name' border=0 onClick="scrTaker(1)" style="cursor: hand">
            <img src='img/sgi_chocolate/scr_subject_chk.gif' name='scr_subject' border=0 onClick="scrTaker(2)" style="cursor: hand">
            <img src='img/sgi_chocolate/scr_comment.gif' name='scr_comment' border=0 onClick="scrTaker(3)" style="cursor: hand">
          </td>
        </tr>
        </form>
      </table>
  ...
  <tr>
    ...
    <td colspan=7 background='img/sgi_chocolate/tail_bg.gif'></td>
